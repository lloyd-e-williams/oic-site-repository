...
![](./images/tutorial103/a.png)

Choose the **Style: Template with Pattern: Map Data**

![b-7834999](./images/tutorial103/b-7834999.png)

Name the Integration:  `REST to File Integration <your initials>`
...
![Screen Shot 2018-03-05 at 8.06.38 AM](./images/tutorial103/c.png)

Click the **Create** button.

The integration has been created. Click the **Save** button to save the work so far.

![Screen Shot 2018-03-05 at 8.09.23 AM](./images/tutorial103/d.png)
...
![Screen Shot 2018-03-05 at 8.11.58 AM](./images/tutorial103/e.png)

Choose the `Local REST <your initials>` connection.

![](./images/tutorial103/f.png)
...
![Screen Shot 2018-03-05 at 8.33.38 AM](images/tutorial103/h.png)
...
![Screen Shot 2018-03-05 at 8.41.20 AM](./images/tutorial103/i.png)
...
![Screen Shot 2018-03-05 at 8.46.13 AM](./images/tutorial103/j.png)

Click **Done**

The integration is not finished yet, but click on the **Save** button to save the work you have done so far.

![Screen Shot 2018-03-05 at 8.47.39 AM](./images/tutorial103/k.png)
...
![Screen Shot 2018-03-05 at 8.51.41 AM](./images/tutorial103/l.png)
...
![Screen Shot 2018-03-05 at 8.57.36 AM](images/tutorial103/m.png)
...
![Screen Shot 2018-03-05 at 9.09.56 AM](./images/tutorial103/n.png)
...
![Screen Shot 2018-03-05 at 9.15.07 AM](./images/tutorial103/o.png)
...
![Screen Shot 2018-03-05 at 9.15.53 AM](./images/tutorial103/p.png)
...
![Screen Shot 2018-03-05 at 9.18.27 AM](./images/tutorial103/q.png)

A mapping wizard will appear. Drag from the `PersonId` in the source to the `PersonId` under `People/Person`.

![Screen Shot 2018-03-05 at 9.20.52 AM](./images/tutorial103/r.png)

![Screen Shot 2018-03-05 at 9.22.33 AM](./images/tutorial103/s.png)

Do the same for the `Name` field.

![Screen Shot 2018-03-05 at 9.25.18 AM](./images/tutorial103/t.png)

Then click the **Validate** button and then the **Close** button.

![Screen Shot 2018-03-05 at 9.26.59 AM](./images/tutorial103/u.png)

Click the **Save** button. Notice the completion percentage is not yet at 100%. This is because we need to configure the tracking option.

### Part 5: Configure Tracking

Choose the menu next to the Last Saved field.

![Screen Shot 2018-03-05 at 9.29.42 AM](./images/tutorial103/v.png)



Choose **Tracking**

![Screen Shot 2018-03-05 at 9.31.10 AM](images/tutorial103/w.png)
...
![Screen Shot 2018-03-05 at 9.32.09 AM](images/tutorial103/x.png)
...
![Screen Shot 2018-03-05 at 9.32.17 AM](images/tutorial103/y.png)

Click **Save**

![Screen Shot 2018-03-05 at 9.36.33 AM](images/tutorial103/z.png)

Notice that the the integration is now at 100% and ready to activate. Click **Close**

### Part 6: Activate the Integration

Notice that there is an actions menu associated with this integration.

![Screen Shot 2018-03-05 at 9.39.47 AM](images/tutorial103/z1.png)
...
![Screen Shot 2018-03-05 at 10.05.45 AM](images/tutorial103/z2.png)
...
![Screen Shot 2018-03-05 at 10.09.27 AM](images/tutorial103/z3.png)

You will need to click on the **Refresh** icon to see if the integation has finished activating.

![Screen Shot 2018-03-05 at 10.10.54 AM](images/tutorial103/z4.png)
...
![Screen Shot 2018-03-05 at 11.19.21 PM](images/tutorial103/z5.png)



![Screen Shot 2018-03-05 at 10.13.21 AM](images/tutorial103/z6.png)

### Part 7: Test Integration

The integration is now ready to run. It's best to use a tool for testing REST interfaces (for example Postman or SOAP-UI) to test the interface. In this tutorial, we will use Postman which is available as a stand-alone install or a Chrome browser plug-in.
...
![Screen Shot 2018-03-05 at 10.33.46 AM](images/tutorial103/z7.png)
...
![Screen Shot 2018-03-05 at 10.36.18 AM](images/tutorial103/z8.png)



Notice that `Authorization` and `Content-Type` Headers were generated automatically. You do not need to adjust these values.

![Screen Shot 2018-03-05 at 10.40.05 AM](images/tutorial103/z9.png)
...
![Screen Shot 2018-03-05 at 10.42.48 AM](images/tutorial103/z91.png)



Ask your instructor to check and see if your file was created on the computer running the agent.

![Screen Shot 2018-03-05 at 10.30.37 AM](images/tutorial103/z92.png)
...
![Screen Shot 2018-03-05 at 10.50.26 AM](images/tutorial103/z93.png)



![Screen Shot 2018-03-05 at 10.57.15 AM](images/tutorial103/z94.png)
...
![Screen Shot 2018-03-05 at 10.53.45 AM](images/tutorial103/z95.png)
